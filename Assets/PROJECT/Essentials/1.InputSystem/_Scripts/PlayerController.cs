...
public class PlayerController : MonoBehaviour
{
    ...
    private float _terminalVelocity = 25.0f;
    ...
    private int _animIDEnemyInRange;
    ...
    private void AssignAnimationIDs()
    {
        ...
        _animIDEnemyInRange = Animator.StringToHash("EnemyInRange");
    }
    #endregion
    ...
    private void JumpAndGravity()
    {
        ...
        if (_verticalVelocity < _terminalVelocity && _verticalVelocity > -50f)
        {
    ...
    private void Move()
    {
        ...
        // move the player
        _controller.Move(new Vector3(_input.move.x, 0f, _input.move.y).normalized * (_speed * Time.deltaTime) +
    ...
    // {
    // if (!EnemySensor.Instance.EmptyList)
    // {
    //     Enemy enemy = EnemySensor.Instance.GetFirstEnemy();
    //     EnemySensor.Instance.SetTargetMark(enemy);
    //     Vector3 enemyPosition = enemy.transform.position;

    //     _targetRotation = Mathf.Atan2(enemyPosition.x - transform.position.x, enemyPosition.z - transform.position.z) * Mathf.Rad2Deg +
    //                       _mainCamera.transform.eulerAngles.y;
